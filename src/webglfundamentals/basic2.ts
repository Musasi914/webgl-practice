import fragmentShaderSource from "/shader/webglfundamentals/basic2/fragmentShader.glsl?raw";
import vertexShaderSource from "/shader/webglfundamentals/basic2/vertexShader.glsl?raw";
...
gl.bufferData(gl.ARRAY_BUFFER, new Float32Array([0, 0, 300, 0, 0, 200, 300, 0, 0, 200, 300, 200]), gl.STATIC_DRAW);
...
const scale = [1, 1];
const a = mat3.projection(mat3.create(), canvas.clientWidth, canvas.clientHeight);
